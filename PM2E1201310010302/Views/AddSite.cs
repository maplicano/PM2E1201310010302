...
namespace PM2E1201610010417.Views
{
    public class AddSite : ContentPage
    {
        ...
        public AddSite()
        {
            ...
            descEntry.Placeholder = "Descripción larga";
            stackLayout.Children.Add(descEntry);

            // Descripcion corta
            Desexacta = new Editor();
            Desexacta.Keyboard = Keyboard.Text;
            Desexacta.Placeholder = "Descripción corta";
            stackLayout.Children.Add(Desexacta);
            ...
            saveButton.Text = "Salvar ubicacion casa";
